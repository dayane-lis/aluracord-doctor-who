...
function Titulo(props) {
    ...
    return (
        <>
            ...
            <style jsx>{`
            ${Tag} {
                color: ${appConfig.theme.colors.neutrals['110']};
                font-size: 24px;
                font-weight: 600;
            }
            `}</style>
            ...
            >
                <Box
                    styleSheet={{
                        ...
                        backgroundColor: appConfig.theme.colors.neutrals[700], opacity: 0.8,
                    }}
                >
                    {/* Formulário */}
                    <Box
                    ...
                    >
                        ...
                        {/* <input 
                            ...
                            onChange={function (event) {
                                ...
                                // Troque através do React e avise quem precisa
                                setUsername(valor);
                            }}
                        /> */}
